...
const CalendarGrid = ({ events, onEventClick, onToggleComplete, onEventUpdate }) => {
  ...
  const handlePrev = () => {
    ...
    else setCurrentDate(addDays(currentDate, -1)); // fallback
  };
  ...
  const renderAgendaView = () => {
    ...
    return (
      <div className="space-y-6 max-w-3xl mx-auto h-[700px] overflow-y-auto custom-scrollbar p-4 bg-slate-900/60 rounded-2xl border border-slate-700/50 backdrop-blur-xl">
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-xl font-bold text-white w-56 text-center drop-shadow-sm">
